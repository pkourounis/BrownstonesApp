...
export default async function BuildSchedulePage({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="card">
        <h2 className="font-semibold text-brand-900">Build the week&apos;s shifts — next</h2>
        <p className="mt-1 text-sm text-brand-600">
          Next we&apos;ll turn these targets into actual shifts: drop people from your Toast roster onto each day, and the app
          checks coverage against these numbers and against real punches. Scheduling moves out of Sling and into here.
        </p>
      </div>
    </div>
  );
